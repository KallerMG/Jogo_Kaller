...
# laser tiros
tiro_1 = pygame.image.load(os.path.join("imagens","pixel_laser_red.png")) #trocar imgagem
tiro_2 = pygame.image.load(os.path.join("imagens","pixel_laser_green.png")) #trocar imgagem
tiro_3 = pygame.image.load(os.path.join("imagens","pixel_laser_blue.png")) #trocar imgagem
tiro_4 = pygame.image.load(os.path.join("imagens","pixel_laser_yellow.png")) #trocar imgagem

#fundo

fundo = pygame.transform.scale(pygame.image.load(os.path.join("imagens","fundo-galaxia-realista.jpg")),(altura,largura)) 
...
class Inimigo(Nave):
    ...
    def atirar(self):
        if self.tempo_de_espera == 0:
            tiro = Tiro(self.x -15, self.y, self.tiro_img)
            self.tiros.append(tiro)
            self.tempo_de_espera = 1
